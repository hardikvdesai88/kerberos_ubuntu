root@slave0:/home/ec2-user/ambari# cat setup_kerberos.sh
#!/bin/bash
...
PROP=ambari.props
REALM=NS1.COM
source /home/ec2-user/ambari/$PROP
AMBARI_HOST=10.140.177.76
AMBARI_ADMIN_USER=admin
AMBARI_ADMIN_PASSWORD=admin
CLUSTER_NAME=ns1server
#############
...
setup_kdc()
{
        ...
        #apt-get -y install krb5-server krb5-libs krb5-workstation
        ...
        sed -i.bak "s/EXAMPLE.COM/$REALM/g" /etc/krb5kdc/kadm5.acl
        echo -e "\n`ts` Restarting krb5-admin-server"
